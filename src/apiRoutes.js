...
export const apiRoutes = {
  ...
  organizationUnit:
    path + process.env.REACT_APP_SETTINGS_PORT + "/api/OrganizationUnit",
  //Indicator
  project: path + process.env.REACT_APP_INDICATOR_PORT + "/api/Project",
  donorProcessLevel:
    path + process.env.REACT_APP_INDICATOR_PORT + "/api/DonorProcessLevel",
  processLevelContact:
    path + process.env.REACT_APP_INDICATOR_PORT + "/api/ProcessLevelContact",
  processLevelRole:
    path + process.env.REACT_APP_INDICATOR_PORT + "/api/ProcessLevelRole",
  projectAdministrativeProgramme:
    path +
    process.env.REACT_APP_INDICATOR_PORT +
    "/api/ProjectAdministrativeProgramme",
  implementingOrganisation:
    path +
    process.env.REACT_APP_INDICATOR_PORT +
    "/api/ImplementingOrganisation",
  administrativeProgramme:
    path +
    process.env.REACT_APP_INDICATOR_PORT +
    "/api/AdministrativeProgramme",
  // external
  ERPStaffList: "https://stagingapi.amref.org/api/erpStaffList?unit=HQ",
  administrativeRoles:
    "https://stagingapi.amref.org/api/workflowStepApproverRoles_View",
};
