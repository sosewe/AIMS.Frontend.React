...
export const apiRoutes = {
  ...
  advocacyDonor: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/Advocacy`,
  advocacyPartner: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/Advocacy`,
  advocacyStaff: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/Advocacy`,
