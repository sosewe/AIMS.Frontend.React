...
export const apiRoutes = {
  ...
  technicalAssistanceObjectiveLink: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/TechnicalAssistanceObjectiveLink`,
  technicalAssistanceAgency: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/TechnicalAssistanceAgency`,
  technicalAssistanceModality: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/TechnicalAssistanceModality`,
  technicalAssistanceQuarterlyUpdate: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/TechnicalAssistanceQuarterlyUpdate`,
  technicalAssistanceKMDocumentUpload: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/TechnicalAssistanceKMDocumentUpload`,
