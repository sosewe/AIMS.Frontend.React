...
export const apiRoutes = {
  ...
  innovationMonitoringUpdate: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/InnovationMonitoringUpdate`,
  innovationMonitoringTechnicalReview: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/InnovationMonitoringTechnicalReview`,
  innovationMonitoringScaleUp: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/InnovationMonitoringScaleUp`,
  innovationMonitoringUserSatisfaction: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/InnovationMonitoringUserSatisfaction`,
  innovationMonitoringKMDocumentsUpload: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/InnovationMonitoringKMDocumentsUpload`,
  ...
  technicalAssistanceObjectiveClassification: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/TechnicalAssistanceObjectiveClassification`,
  technicalAssistanceObjective: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/TechnicalAssistanceObjective`,
  technicalAssistanceChallenge: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/TechnicalAssistanceChallenge`,
  technicalAssistanceProgress: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/TechnicalAssistanceProgress`,
  technicalAssistanceMetric: `${path}${process.env.REACT_APP_INDICATOR_PORT}/api/TechnicalAssistanceMetric`,
