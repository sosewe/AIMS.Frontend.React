...
const InnovationUpdateDetailsForm = ({ handleClick }) => {
...
const RiskDetailsForm = ({ handleClick }) => {
  const formik = useFormik({
    initialValues: initialValues,
    validationSchema: Yup.object().shape({
      metric: Yup.object().required("Required"),
      ...
      {formik.isSubmitting ? (
        ...
        <Grid container item spacing={2}>
          ...
          >
            ...
            <DialogContent>
              <InnovationUpdateDetailsForm
                handleClick={handleAddInnovationUpdate}
              />
            </DialogContent>
            <DialogActions>
              <Button
          ...
          >
            ...
            <DialogContent>
              <RiskDetailsForm handleClick={handleAddInnovationUpdate} />
            </DialogContent>
            <DialogActions>
